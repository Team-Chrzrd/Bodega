  ...
  Mutation: {
    ...
    async pantryQtyDown(_, args) {
      try {
        ...
        console.log('error in shopping.js/pantryQtyDown', error);
        return { success: false };
      }
    },
    ...
    async pantryParUp(_, args) {
      try {
        ...
        console.log('error in shopping.js/pantryParUp', error);
        return { success: false };
      }
    },
    ...
    async pantryParDown(_, args) {
      try {
        ...
        console.log('error in shopping.js/pantryParDown', error);
        return { success: false };
      }
    },
